...
<div class="weui-panel weui-panel_access">
    <div class="weui-panel__bd">
        ...
        <a class="weui-media-box weui-media-box_text" href="/match/{{ $match->id }}" style="display: block">
            <h4 class="weui-media-box__title">{{ $match->title }}
                <span class="weui-badge" style="float: right;">火热招募</span>
            </h4>
            <p class="weui-media-box__desc">{{ $match->sub_title }}</p>
            <ul class="weui-media-box__info">
                <li class="weui-media-box__info__meta">发布时间</li>
                <li class="weui-media-box__info__meta">{{ $match->created_at->diffForHumans() }}</li>
